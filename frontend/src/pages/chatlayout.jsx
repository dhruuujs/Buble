...
import CreateChat from '../components/chatComponents/CreateChat.jsx';
import FriendList from '../components/chatComponents/friendlist.jsx';
import Profile from '../components/settingComponents/profile.jsx'
    ...
    <div className="flex">    
            ...
            <div className="w-[12vw] overflow-hidden h-[calc(100%-2vh)] bg-[#17191b]">
              <ol>
                ...
                <li>Help</li>
                <br/>
                <li className="mt-[90%] activeSettingBtn">Profile</li>
              </ol>
              </div>
